...
var whitelist = ingredient.matchAny([
  ...
  ingredient.mod('tconstruct'),
  ingredient.mod('immersiveengineering'),
  ingredient.mod('create'),
  ingredient.mod('computercraft'),
  ingredient.mod('ae2'),
  ingredient.mod('ae2additions'),
  ingredient.mod('lazierae2'),
  'minecraft:emerald'
]);
